                  ...
                  <div className="card-content flex-grow-1">
                   <div>
                    ...
                    <div className="text-muted-custom mb-2">
                      <span ><img src="/img/date_icon.svg" /> {event.date}</span>
                      <span ><img src="/img/loc_icon.svg" /> {event.loc}</span>
                    </div>
                   </div>
                    ...
                    <Popup className="custom-popup">
                      ...
                      <div className="popup-text">
                        ...
                        <ul className='map_list'>
                          <li><img src="/img/location_map.svg" />Nirwana Plot</li>
                          <li><img src="/img/datemap.svg" />20.12.2022</li>
                        </ul>
                      </div>
                    </Popup>
                  </Marker>
